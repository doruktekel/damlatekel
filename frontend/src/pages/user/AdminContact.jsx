...
const AdminContact = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!formData.info) {
      toast.error("İletişim bilgisini doldurunuz");
      return;
    }
    ...
    try {
      ...
      toast.success("İletişim bilgisi başarıyla güncellendi");
    } catch (error) {
      console.log(error);
      ...
      >
        <div className="flex flex-col gap-2">
          <label htmlFor="info" className="font-semibold">
            <span className="text-red-600"> * </span> İletişim Bilgisi
          </label>

...
const AdminEskizs = () => {
  const { loading, datas } = useGetAllDraws("/api/work/eskizs/all-eskizs");
  ...
  const handleDelete = (row) => {
    deleteDraw(row.imageName, `/api/work/eskizs/${row._id}`);
  };
  ...
  return (
    <div className="pt-32 pb-32 pl-80 pr-20 bg-gray-300 text-slate-700 min-h-screen flex flex-col gap-10">
      <p className="font-bold text-xl text-center">- Eskizler -</p>
